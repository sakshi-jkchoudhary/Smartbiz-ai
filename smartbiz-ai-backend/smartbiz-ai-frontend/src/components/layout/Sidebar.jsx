...
export default function Sidebar() {
  ...
  // Live Date Formatter for the top empty space
  ...
  return (
    <aside className="w-64 h-full bg-white dark:bg-slate-900 border-r border-slate-100 dark:border-slate-800 flex flex-col justify-between py-4 transition-colors duration-200">
      <div className="space-y-4">
        {/* Top Empty Space Filled With Dynamic Live Date */}
        <div className="px-3 pb-2 text-[11px] font-medium tracking-wider uppercase text-slate-400 dark:text-slate-500 border-b border-slate-50 dark:border-slate-800/40">
          📅 {formattedDate}
        </div>
